...
\includegraphics[height=2.7in]{images/BasisSpread_all_swap_5Y}
...
\begin{tabular}{ |l|l|l|r|r| }
\hline
Year & Price Samples Total & Used in Chap.~\ref{Liao_chapter} & in Sec.~\ref{govt_section} & in Sec.~\ref{corp_cip_section} \\
\hline
...
\includegraphics[height=2.7in]{images/Basis_all_govt_5Y}
...
\includegraphics[height=2.7in]{images/BasisSpread_all_swapgovt_5Y}
...
\includegraphics[height=2.7in]{images/Basis_all_bank_3M}
...
\includegraphics[height=2.7in]{images/Basis_all_xcbs_5Y}
...
Figure~\ref{CIP_basis_swap5} is a plot of CIP basis using swap rates with a 5-year horizon.  Swap rates may have been used for CIP research, but there a number of issues which may prevent them being a good replacement for OIS and LIBOR 3M.  This will be addressed in Section~\ref{govt_section}.
...
\includegraphics[width=.97\textwidth, height=2.7in, left]{images/Liao2016Figure4_#1_xcbs}
\noindent \textbf{Panel B:} \newline
\includegraphics[width=.76\textwidth, height=2.7in, right]{images/Liao2016Figure4_#1_orig}
...
\noindent \textbf{Panel A:} \newline
\includegraphics[height=2.7in]{images/Liao2016Figure5_xcbs_bounded}
\newline 
\noindent \textbf{Panel B:} \newline
\includegraphics[height=2.7in]{images/Liao2016Figure5_orig}
\newline 
...
\chapter{Extensions} \label{extensions_chapter}

Two new studies were done using corporate bonds.  First, I reperformed Liao's analysis, except using government bond rates as the reference interest rate instead of swap rates.   Second, I estimated CIP basis using corporate bond rates and compared the result to that gotten using government and swap rates.

\section{Alternative Interest Rate} \label{govt_section}

Liao's study, as well as others in the field, uses the swap rate instead of a government bond rate to compute the CIP basis.  This section presents reasons why this may not be good practice and then reproduces the results of Chapter~\ref{Liao_chapter} using government bond rates as the reference rate.

\subsection{Reasons Not To Use the Swap Rate} \label{not_swap_subsection}

% The swap rate is not an interest rate.  That is, there exist bonds with the same risk and duration with lower prices or, equivalently, higher yields.  In this chapter, I'll define the swap rate, explain why it is not an interest rate, and provide some small evidence that it is not acting like an interest rate in practice.
...
\noindent \textbf{Panel A:} \newline
\includegraphics[height=2.7in]{images/SwapVsGovt_all_2Y.eps}
\noindent \textbf{Panel B:} \newline
\includegraphics[height=2.7in]{images/SwapVsGovt_all_20Y.eps}
...
\noindent \textbf{Panel A:} \newline
\includegraphics[height=2.7in]{images/Liao2016Figure4_#1_govt}
\noindent \textbf{Panel B:} \newline
\includegraphics[height=2.7in]{images/Liao2016Figure4_#1_xcbs} 
...
\noindent \textbf{Panel A:} \newline
\includegraphics[height=2.7in]{images/Liao2016Figure5_govt_alldata}
\newline 
\noindent \textbf{Panel B:} \newline
\includegraphics[height=2.7in]{images/Liao2016Figure5_xcbs_alldata}
\newline 
...
\section{Measuring Corporate CIP Basis} \label{corp_cip_section}
...
\includegraphics[height=2.7in]{images/Basis_all_corp_5Y}
...
\includegraphics[height=2.7in]{images/BasisSpread_all_all_5Y}
...
\includegraphics[height=2.7in]{images/Basis_all_govtMinusCorp_5Y}
...
\includegraphics[height=2.7in]{images/Basis_all_swapMinusCorp_5Y}
...
\includegraphics[height=2.7in]{images/Basis_EUR_corp_5Y}
...
\includegraphics[height=2.7in]{images/Basis_JPY_corp_5Y}
...
\includegraphics[height=2.7in]{images/Basis_CHF_corp_5Y}
\newline Note: {\small CIP basis using corporate rates in blue (dotted) with 95\% conf. int. in gray, using government rates in red (solid), and using swap rates in orange (dashed). }
%Note: {\small CIP basis values inferred from a corporate bond rates are in blue (dotted), with 95\% confidence interval from clustered standard error in gray. The CIP basis calculated from government bond rates are in red (solid).  The CIP basis using swaps rates is in orange (dashed).  }
\newline Source: Central banks, Bloomberg L.P. 
\end{figure}
...
\includegraphics[height=2.7in]{images/Basis_GBP_corp_5Y}
\newline Note: {\small CIP basis using corporate rates in blue (dotted) with 95\% conf. int. in gray, using government rates in red (solid), and using swap rates in orange (dashed). }
%Note: {\small CIP basis values inferred from a corporate bond rates are in blue (dotted), with 95\% confidence interval from clustered standard error in gray. The CIP basis calculated from government bond rates are in red (solid).  The CIP basis using swaps rates is in orange (dashed).  }
\newline Source: Central banks, Bloomberg L.P. 
\end{figure}
...
\includegraphics[height=2.7in]{images/Basis_AUD_corp_5Y}
\newline Note: {\small CIP basis using corporate rates in blue (dotted) with 95\% conf. int. in gray, using government rates in red (solid), and using swap rates in orange (dashed). }
%Note: {\small CIP basis values inferred from a corporate bond rates are in blue (dotted), with 95\% confidence interval from clustered standard error in gray. The CIP basis calculated from government bond rates are in red (solid).  The CIP basis using swaps rates is in orange (dashed).  }
\newline Source: Central banks, Bloomberg L.P. 
\end{figure}
...
\includegraphics[height=2.7in]{images/Basis_CAD_corp_5Y}
\newline Note: {\small CIP basis using corporate rates in blue (dotted) with 95\% conf. int. in gray, using government rates in red (solid), and using swap rates in orange (dashed). }
%Note: {\small CIP basis values inferred from a corporate bond rates are in blue (dotted), with 95\% confidence interval from clustered standard error in gray. The CIP basis calculated from government bond rates are in red (solid).  The CIP basis using swaps rates is in orange (dashed).  }
\newline Source: Central banks, Bloomberg L.P. 
\end{figure}
...
\includegraphics[height=2.7in]{images/Basis_SEK_corp_5Y}
\newline Note: {\small CIP basis using corporate rates in blue (dotted) with 95\% conf. int. in gray, using government rates in red (solid), and using swap rates in orange (dashed). }
%Note: {\small CIP basis values inferred from a corporate bond rates are in blue (dotted), with 95\% confidence interval from clustered standard error in gray. The CIP basis calculated from government bond rates are in red (solid).  The CIP basis using swaps rates is in orange (dashed).  }
\newline Source: Central banks, Bloomberg L.P. 
\end{figure}
...
\includegraphics[height=2.7in]{images/Basis_NOK_corp_5Y}
\newline Note: {\small CIP basis using corporate rates in blue (dotted) with 95\% conf. int. in gray, using government rates in red (solid), and using swap rates in orange (dashed). }
%Note: {\small CIP basis values inferred from a corporate bond rates are in blue (dotted), with 95\% confidence interval from clustered standard error in gray. The CIP basis calculated from government bond rates are in red (solid).  The CIP basis using swaps rates is in orange (dashed).  }
\newline Source: Central banks, Bloomberg L.P. 
\end{figure}
...
\includegraphics[height=2.7in]{images/Basis_NZD_corp_5Y}
\newline Note: {\small CIP basis using corporate rates in blue (dotted) with 95\% conf. int. in gray, using government rates in red (solid), and using swap rates in orange (dashed). }
%Note: {\small CIP basis values inferred from a corporate bond rates are in blue (dotted), with 95\% confidence interval from clustered standard error in gray. The CIP basis calculated from government bond rates are in red (solid).  The CIP basis using swaps rates is in orange (dashed).  }
\newline Source: Central banks, Bloomberg L.P. 
\end{figure}
...
% \includegraphics[height=2.7in]{images/Basis_XY_corp_5Y}
...
% \includegraphics[height=2.7in]{images/GovtBasisVsRate_all_5Y}
% \newline 
...
% \includegraphics[height=2.7in]{images/SwapBasisVsRate_all_5Y}
% \newline 
...
% \includegraphics[height=2.7in]{images/CorpBasisVsRate_all_5Y}
% \newline 
